...
package com.behsacorp.ganjex.container;
 ...
 * the {@link com.behsacorp.ganjex.api.GanjexConfiguration} and registering all of them into
 * {@link com.behsacorp.ganjex.lifecycle.LifecycleManagement} instance.
 *
 * @author hekmatof
 * @since 1.0
 */
public final class HookLoader {
     ...
     * {@link com.behsacorp.ganjex.lifecycle.LifecycleManagement} instance of the container.
     */
    ...
    private void registerHooksOfObject(Object object) {
        Stream.of(object.getClass().getMethods())
                ...
                .forEach(method -> app.lifecycleManagement().registerStartupHook(
                        new com.behsacorp.ganjex.lifecycle.StartupHook(createHook(method, object),
        ...
        Stream.of(object.getClass().getMethods())
                ...
                .forEach(method -> app.lifecycleManagement().registerShutdownHook(
                        new com.behsacorp.ganjex.lifecycle.ShutdownHook(createHook(method, object),
