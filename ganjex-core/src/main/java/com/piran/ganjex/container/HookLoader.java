 ...
 * the {@link com.piran.ganjex.api.GanjexConfiguration} and registering all of them into
 * {@link com.piran.ganjex.lifecycle.LifecycleManagement} instance.
 *
 * @author hekmatof
 * @since 1.0
 */
public final class HookLoader {
     ...
     * {@link com.piran.ganjex.lifecycle.LifecycleManagement} instance of the container.
     */
    ...
    private void registerHooksOfObject(Object object) {
        Stream.of(object.getClass().getMethods())
                ...
                .forEach(method -> app.lifecycleManagement().registerStartupHook(
                        new com.piran.ganjex.lifecycle.StartupHook(createHook(method, object),
        ...
        Stream.of(object.getClass().getMethods())
                ...
                .forEach(method -> app.lifecycleManagement().registerShutdownHook(
                        new com.piran.ganjex.lifecycle.ShutdownHook(createHook(method, object),
